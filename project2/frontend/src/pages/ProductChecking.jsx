                  ...
                  >
                    ...
                    <div class="text-center  product-image-container-with-overlay">
                      <img
                        ...
                        style={{ height: "100%", objectFit: item?.useBg ? "cover" : "contain" ,width:"100%"}}
                      />
                    </div>

                    {/* <div
                      className={`text-center product-image-container ${
                        item?.useBg ? "with-bg" : ""
                      }`}
                    >
                      <img
                        src={item?.img1}
                        alt="itemImg"
                        className=" product-image" style={{objectFit:"contain"}}
                      />
                    </div> */}
