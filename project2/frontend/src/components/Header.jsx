      ...
      <header className="fixed-top bg-white shadow-sm">
        <div className="container-fluid px-3">
          <div className="d-flex align-items-center justify-content-between py-2">
            ...
            {/* Logo */}
            <Link to="/">
              <img src="/logo4.png" alt="logo" height="45" />
            </Link>

            {/* Desktop Menu */}
            <ul className="nav gap-4 d-none d-md-flex align-items-center">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <Link className="dropdown-item" to="/collections/men/t-shirt">T-Shirts</Link>
                  <Link className="dropdown-item" to="/collections/men/shirt">Shirts</Link>
                </ul>
              </li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <Link className="dropdown-item" to="/collections/women/t-shirt">T-Shirts</Link>
                  <Link className="dropdown-item" to="/collections/women/shirt">Shirts</Link>
                </ul>
              </li>
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <Link to="/cartFetch" className="nav-link">
              ...
              <div className="dropdown d-none d-md-block">
                ...
                <ul className="dropdown-menu dropdown-menu-end">
                  <Link className="dropdown-item" to={user ? "/profile" : "/login"}>
                    My Profile
                  </Link>
      ...
      <div className="offcanvas offcanvas-start" id="mobileMenu">
        ...
        <div className="offcanvas-body">
          <ul className="nav flex-column gap-2">
            ...
            <Link className="nav-link" to="/collections/men/t-shirt">Men</Link>
            <Link className="nav-link" to="/collections/women/t-shirt">Women</Link>
            <Link className="nav-link" to="/collections/kids/t-shirt">Kids</Link>
          </ul>
        </div>
      </div>
